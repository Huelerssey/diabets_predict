...
def construcao_projeto():
    ...
    st.dataframe(carregar_tabela_pkl().head(10), hide_index=True)
    ...
    # cacula a correlação
    correlation = carregar_tabela_pkl().corr()[['diabetes']]
    ...
    with st.container():
        ...
        sns.countplot(x='diabetes', data=carregar_tabela_pkl(), ax=ax)
        col1.pyplot(fig)
        st.write("")
        ...
        fig, ax = plt.subplots(figsize=(5, 4))
        sns.countplot(x='gender', data=carregar_tabela_pkl(), ax=ax)
        col2.pyplot(fig)
        st.write("")
        ...
        sns.countplot(x='smoking_history', data=carregar_tabela_pkl(), ax=ax)
        col3.pyplot(fig)
        st.write("")
    ...
    with st.container():
        ...
        fig, ax = plt.subplots(figsize=(5, 4))
        sns.histplot(carregar_tabela_pkl()['age'], bins=30, kde=True, ax=ax)
        col1.pyplot(fig)
        st.write("")
        ...
        sns.histplot(carregar_tabela_pkl()['bmi'], bins=30, kde=True, ax=ax)
        col2.pyplot(fig)
        st.write("")
        ...
        fig, ax = plt.subplots(figsize=(5, 4))
        sns.histplot(carregar_tabela_pkl()['HbA1c_level'], bins=30, kde=True, ax=ax)
        col1.pyplot(fig)
        st.write("")
        ...
        fig, ax = plt.subplots(figsize=(5, 4))
        sns.histplot(carregar_tabela_pkl()['blood_glucose_level'], bins=30, kde=True, ax=ax)
        col2.pyplot(fig)
        st.write("")
    ...
    with st.container():
        ...
        fig, ax = plt.subplots(figsize=(5, 4))
        sns.boxplot(x='diabetes', y='age', data=carregar_tabela_pkl(), ax=ax)
        col1.pyplot(fig)
        st.write("")
        ...
        fig, ax = plt.subplots(figsize=(5, 4))
        sns.boxplot(x='diabetes', y='bmi', data=carregar_tabela_pkl(), ax=ax)
        col2.pyplot(fig)
        st.write("")
        ...
        fig, ax = plt.subplots(figsize=(5, 4))
        sns.boxplot(x='diabetes', y='HbA1c_level', data=carregar_tabela_pkl(), ax=ax)
        col1.pyplot(fig)
        st.write("")
        ...
        sns.boxplot(x='diabetes', y='blood_glucose_level', data=carregar_tabela_pkl(), ax=ax)
        col2.pyplot(fig)
        st.write("")
    ...
    with st.container():
        ...
        # plota um gráfico de pizza
        fig, ax = plt.subplots(figsize=(5, 4))
        carregar_tabela_pkl()['diabetes'].value_counts().plot(kind='pie', autopct='%1.1f%%', ax=ax)
        ax.set_ylabel('')
        col2.pyplot(fig)
